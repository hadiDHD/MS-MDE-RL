...
public class IndividualState implements Encodable {

    byte[] state;

    public IndividualState(byte[] state) {
        this.state = state;
    }

    public IndividualState(Microservice[] microservices, Method method, int[] methodsInServices, int MAX_MICROSERVICE) {
